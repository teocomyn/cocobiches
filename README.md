...
Le site est pensé pour un public **francophone et international** : contenus en **français** et en **anglais**, avec une entrée par défaut sur le français.
...
## Maintenance du site (technique)

Ce dépôt contient le code source du site public Cocobiches. Après clonage, à la racine : `npm install`, puis `npm run dev`. Les variables optionnelles (URL du site, relais des formulaires contact et newsletter, audience) sont décrites dans [`.env.example`](.env.example).
