...
export function HjpChambresPageView({ locale }: { locale: Locale }) {
  const p = getHjpContent(locale).hotelPage;
  const hero = hjpImage("chambre");

  return (
    <>
      <section className="relative min-h-[44vh] overflow-hidden bg-cocobiches-marine-900 md:min-h-[48vh]">
        <Image
          src={hero.src}
          alt={hjpAlt("chambre", locale)}
          fill
          priority
        ...
        />
        <div
          className="absolute inset-0 bg-gradient-to-t from-cocobiches-marine-900 via-cocobiches-marine-900/50 to-hjp-teal/20"
          aria-hidden
        />
        <div className="relative mx-auto flex min-h-[44vh] max-w-6xl flex-col justify-end px-5 pb-12 pt-32 md:min-h-[48vh] md:px-8 md:pb-16">
      ...
      <section className="border-b border-cocobiches-border/70 bg-white py-14 md:py-16">
