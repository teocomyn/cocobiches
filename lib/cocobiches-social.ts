/** Réseaux sociaux du groupe Cocobiches (HJP + marque ombrelle). */
export const COCO_LINKEDIN_URL =
  "https://www.linkedin.com/company/cocobiches/" as const;
export const COCO_INSTAGRAM_URL =
  "https://www.instagram.com/cocobicheshotels/" as const;

export { HOTELS, HOTEL_LIST } from "./hotels-data";
